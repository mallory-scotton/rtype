...
FOBB AC_SwordBlade::GetLocalBoundingBox(void) const
{
    ...
    bound.center = FVector3(0.0f, 0.0f, -0.5f);

    // Half-extents: covers the full blade length
    bound.extents = FVector3(0.045f, 0.045f, 0.5f);
...
///////////////////////////////////////////////////////////////////////////////
FOBB AC_SwordBlade::GetWorldBoundingBox(void) const
{
    FOBB bound;
...
///////////////////////////////////////////////////////////////////////////////
FAABB AC_SwordBlade::GetWorldAABB(void) const
{
