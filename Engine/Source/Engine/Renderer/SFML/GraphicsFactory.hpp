...
///////////////////////////////////////////////////////////////////////////////
/// \brief Graphics factory implementation for SFML
///
///////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    virtual std::unique_ptr<IShader>
        CreateShader(const FString& shader, EShaderType type) const override;
    ...
    ///////////////////////////////////////////////////////////////////////////
    virtual std::unique_ptr<IShader>
        CreateShader(const UAsset& asset, EShaderType type) const override;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    virtual std::unique_ptr<IRenderTarget> CreateRenderTarget(void
    ) const override;
};
