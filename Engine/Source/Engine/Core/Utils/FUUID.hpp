...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    static const UUID Nil;     //<! Nil UUID (all bits are zero)
    static const UUID World;   //<! World (all 0s) UUID
    static const UUID Local;   //<! Local (all 1s) UUID
...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    /// \brief Generate a filled UUID with the specified byte value
    ///
    /// \param filler Byte value to fill the UUID with
    ///
    /// \return The generated filled UUID
    ///
    ///////////////////////////////////////////////////////////////////////////
    static UUID Fill(UInt8 filler) noexcept;
};
