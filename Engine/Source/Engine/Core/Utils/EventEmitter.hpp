...
protected:
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    TEventEmitter() = default;

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Copy constructor (deleted - not copyable due to unique_ptr)
    ///
    ///////////////////////////////////////////////////////////////////////////
    TEventEmitter(const TEventEmitter&) = delete;

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Copy assignment operator (deleted - not copyable due to
    /// unique_ptr)
    ///
    ///////////////////////////////////////////////////////////////////////////
    TEventEmitter& operator=(const TEventEmitter&) = delete;

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Move constructor
    ///
    ///////////////////////////////////////////////////////////////////////////
    TEventEmitter(TEventEmitter&& other) noexcept
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    TEventEmitter& operator=(TEventEmitter&& other) noexcept
    {
        if (this != &other)
        {
            m_eventQueue = std::move(other.m_eventQueue);
