...
public:
    ...
    static const TVector3 UnitX; //!< A unit vector along the x-axis (1, 0, 0).
    static const TVector3 UnitY; //!< A unit vector along the y-axis (0, 1, 0).
    static const TVector3 UnitZ; //!< A unit vector along the z-axis (0, 0, 1).
