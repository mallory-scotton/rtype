...
public:
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    static void Rotate(TRotator2D<T>& rotator, const TRotator2D<T>& rotation)
    {
        rotator.Rotate(rotation);
    }

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Static method to rotate a rotator by angle
    ///
    /// \param rotator The rotator to rotate
    /// \param angle The angle to add (degrees)
    ///
    ///////////////////////////////////////////////////////////////////////////
    static void Rotate(TRotator2D<T>& rotator, const T& angle)
    {
