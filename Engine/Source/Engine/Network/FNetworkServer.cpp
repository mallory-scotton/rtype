    ...
    namespace tkd
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    bool FNetworkServer::SendPacketToClient(
        ...
        if (updateInfo.property)
        {
            try
            {
                ...
                updateInfo.property->SetValue(
                    updateInfo.propertyData.data(),
                    updateInfo.propertyData.size()
                );
    ...
    ///////////////////////////////////////////////////////////////////////////////
    FConnectionInformation* FNetworkServer::GetClientInformation(
        UInt32 clientID
    ) const
    {
        std::lock_guard<std::mutex> lock(m_connectionsMutex);
