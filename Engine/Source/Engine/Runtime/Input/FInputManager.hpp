...
private:
    ...
    std::map<EInput, bool> m_currentInputStates;    //<! Current input states.
    std::map<EInput, bool> m_previousInputStates;   //<! Current input states.
    FVector2i m_mousePosition;         //<! Current mouse position.
    FVector2i m_mouseDeltaReference;   //<! The reference delta
    FVector2i m_mouseDelta;            //<! The mouse delta
...
public:
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    const FVector2i& GetMousePosition(void) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    const FVector2i& GetMouseDelta(void) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    const FVector2i& GetMouseDeltaReference(void) const;

    ///////////////////////////////////////////////////////////////////////////
    /// \brief
    ///
    ///////////////////////////////////////////////////////////////////////////
    void SetDeltaReference(void);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    bool IsJustPressed(EInput input) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    bool IsPressed(EInput input) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    bool IsJustReleased(EInput input) const;
};
