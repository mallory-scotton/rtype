  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} viewBox='0 0 24 24' fill='none' role='img'>
      ...
      <path
        ...
        fill={color}
      ></path>
      <path fill-rule='evenodd' clip-rule='evenodd' d='M15 9.00006H9V7.00006H15V9.00006Z' fill={color}></path>
      <path fill-rule='evenodd' clip-rule='evenodd' d='M8 15.0001H2V13.0001H8V15.0001Z' fill={color}></path>
      <path fill-rule='evenodd' clip-rule='evenodd' d='M22 13.0001H16V11.0001H22V13.0001Z' fill={color}></path>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
      ...
      <path
        ...
        fill={color}
      ></path>
      <path fill-rule='evenodd' clip-rule='evenodd' d='M20 4.00006L20 12.0001H18L18 4.00006H20Z' fill={color}></path>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
